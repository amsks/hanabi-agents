...
class ExperienceBuffer:
    ...
    def __init__(self,  capacity: int, observation_len: int):
    ...
    def __getitem__(self, indices):
        return Transition(
            ...
            self._rew_t_buf[indices], self._obs_t_buf[indices], self._terminal_t_buf[indices])
    ...
    def change_size(self, new_size):
        ...
        buffer_arrays = ['_obs_tm1_buf', '_act_tm1_buf', '_obs_t_buf', '_rew_t_buf', '_terminal_t_buf']
